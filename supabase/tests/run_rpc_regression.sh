#!/usr/bin/env bash
# Run the Score v2.1 get_my_current_trust_score() RPC regression suite against DEV Supabase.
#
# Required env var:
...
#
# Usage:
#   SUPABASE_ACCESS_TOKEN=<token> ./supabase/tests/run_rpc_regression.sh
set -euo pipefail
...
SQL_FILE="$(dirname "$0")/regression_score_v21_rpc.sql"

echo "=== IOU DEV Score v2.1 RPC Regression Runner (36 checks) ==="
